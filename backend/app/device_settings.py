...
SCHEMA: dict[str, dict[str, Any]] = {
    ...
    "vbat_min": number("float", 2.5, 12, "Порог просадки напряжения, В"),
    "vbat_sag_delta": number("float", 0.05, 3, "Скачок напряжения за замер, В"),
    "temp_rate_per_min": number("float", 0.5, 60, "Предел скорости температуры, °C/мин"),
    "pres_rate_per_min": number("float", 0.1, 30, "Предел скорости давления, гПа/мин"),
    "tds_rate_per_min": number("float", 10, 5000, "Предел скорости TDS, мг/л/мин"),
...
DEFAULTS: dict[str, Any] = {
    ...
    "vbat_min": 3.4,
    "vbat_sag_delta": 0.25,
    "temp_rate_per_min": 6.0,
    "pres_rate_per_min": 2.0,
    "tds_rate_per_min": 400.0,
    "enable_bme": True,
    "enable_tds": True,
    "enable_gps": True,
    "enable_battery": True,
...
KNOWN_COMMANDS = {
    "ping", "publish_now", "get_status",
    "sync_time",
    "set_time",
    "reset_stability",
    "reboot", "factory_reset", "clear_spool",
}
