...
class Measurement(Base):
    ...
    quality: Mapped[str] = mapped_column(String(16), default="ok", server_default="ok")
    ...
    rejected_raw: Mapped[dict | None] = mapped_column(JSONB, nullable=True)
    ...
    __table_args__ = (
        ...
        Index("ix_measurements_quality", "device_id", "quality", "ts"),
    )
