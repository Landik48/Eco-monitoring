...
struct Settings {
  ...
  void toJson(JsonObject o) const {
    ...
    o["vbat_min"] = vbatMin;
    o["vbat_sag_delta"] = vbatSagDelta;
    o["temp_rate_per_min"] = tempRatePerMin;
    o["pres_rate_per_min"] = presRatePerMin;
    o["tds_rate_per_min"] = tdsRatePerMin;
    o["rev"] = rev;
  }
  ...
  bool applyJson(JsonObjectConst o, String& err, bool bumpRev = true) {
    ...
    bool ok =
      ...
      num(o, "vbat_min", draft.vbatMin, 2.5f, 12.0f, err) &&
      num(o, "vbat_sag_delta", draft.vbatSagDelta, 0.05f, 3.0f, err) &&
      num(o, "temp_rate_per_min", draft.tempRatePerMin, 0.5f, 60.0f, err) &&
      num(o, "pres_rate_per_min", draft.presRatePerMin, 0.1f, 30.0f, err) &&
      num(o, "tds_rate_per_min", draft.tdsRatePerMin, 10.0f, 5000.0f, err);
    if (!ok) return false;
